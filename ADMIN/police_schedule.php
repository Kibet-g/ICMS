                ...
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            $start_disable = $row['start_disable'] ?? null;
                            $end_disable = $row['end_disable'] ?? null;

                            if ($start_disable && $end_disable && $current_time >= $start_disable && $current_time <= $end_disable) {
                                echo "Disabled";
                            } else {
                                echo "Active";
                            }
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <?php if ($start_disable && $end_disable && $current_time >= $start_disable && $current_time <= $end_disable): ?>
